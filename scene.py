...
class Scene:
    ...
    def initialize(self) -> None:
        ...
        glLightfv(GL_LIGHT0, GL_DIFFUSE, self.get_light_color_with_intensity())
        glLightfv(GL_LIGHT0, GL_SPECULAR, self.get_light_color_with_intensity())
    ...
    def get_light_color_with_intensity(self) -> Color4f:
    ...
    def setup_light(self) -> None:
        ...
        light_color = self.get_light_color_with_intensity()
